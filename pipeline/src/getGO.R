...
GO_0002181 <- getBM(attributes=c('ensembl_gene_id'), filters = 'go', values ="GO:0002181", mart = yeastgenome) 
GO_0003735 <- getBM(attributes=c('ensembl_gene_id'), filters = 'go', values ="GO:0003735", mart = yeastgenome)
GO_0006413 <- getBM(attributes=c('ensembl_gene_id'), filters = 'go', values ="GO:0006413", mart = yeastgenome)
...
write.table(GO_0002181, "GO0005840.txt",row.names=F,quote=F,col.names=F)
write.table(GO_0003735, "GO0005840.txt",row.names=F,quote=F,col.names=F)
write.table(GO_0006413, "GO0005840.txt",row.names=F,quote=F,col.names=F)
