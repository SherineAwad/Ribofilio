...
def plots(outName,N,coverage,all_bins,binsize, posmax, posmin,last_pos,gLength,ymin,ymax,ylogmin,ylogmax,cutoff,end,regfile):
    ...
    plt.savefig(outName+"_"+str(binsize)+"_"+str(cutoff)+"_"+str(end)+".LR.png", format='png')
...
def main(): 
    ...
    #-----------------------------------------
    plots(outName,N,coverage,gbins,binsize, posmax, posmin,last_pos,gLength,int(args.ymin),int(args.ymax),int(args.ylogmin),int(args.ylogmax),cutoff,int(args.end),args.regfile_name )
